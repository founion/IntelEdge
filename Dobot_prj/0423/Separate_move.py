...
class dobot_sp():
  ...
  def plastic_position(self):
    self.device.move_to(self.j1, self.j2 + 40, self.j3, self.j4, wait=True)
    
  def styrofoam_position(self):
  ...
  def pick_pl(self):
    ...
    self.device.move_to(self.j1 + 90, self.j2 + 10, self.j3 + 50, self.j4, wait=True)
    self.device.wait(200)
    self.device.grip(True)
    self.device.wait(500)
    self.ready_position()
    self.device.wait(200)
    self.plastic_position()
    self.device.wait(200)
    self.device.grip(False)
    self.device.wait(500)
    self.ready_position()
